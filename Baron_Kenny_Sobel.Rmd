...
Now, you should analyse the full data that include multiple mediators. Some R packages might be useful (or not) including [fdrtool](https://cran.r-project.org/web/packages/fdrtool/index.html), and [qvalue](http://bioconductor.org/packages/release/bioc/html/qvalue.html), [hima](https://github.com/YinanZheng/HIMA).
