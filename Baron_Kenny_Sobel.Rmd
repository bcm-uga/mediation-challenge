...
## Baron and Kenny (B&K) procedure with a Sobel test
An additional criterion is sometimes included in Baron and Kenny procedure (see [e.g. Kupers et al. 2015](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4588868/). The Sobel statistic is computed to test that the product of the two regression coefficients $\beta_{21}$ and $\beta_{32}$ (see [Wikipedia notation](https://en.wikipedia.org/wiki/Mediation_(statistics)#Baron_and_Kenny.27s_.281986.29_steps_for_mediation)) is different from 0  ($H_0:\beta_{21} \times \beta_{32}=0$).
